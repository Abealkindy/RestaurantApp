package com.rosinante24.resturantapp.Adapter;
...
import com.rosinante24.resturantapp.R;
...
public class RestaurantAdapter extends FirestoreAdapter<RestaurantAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(inflater.inflate(R.layout.item_list_restaurant, parent, false));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.image_item_restaurant)
        ImageView imageView;
